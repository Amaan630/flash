...
#pragma warning restore 0414
        ...
        void UpdateSimulationMaterial()
        {
            ...
            if (enableCollision && collisionDepthSource == CollisionDepthSource.ThisEmitter)
            {
                ...
                depthTexture = new RenderTexture(depthTextureResolution, depthTextureResolution, 16, RenderTextureFormat.Depth, RenderTextureReadWrite.Linear);
            ...
            {
                if(depthTexture != null) depthTexture = null;
        ...
        {
            if (!enableCollision || collisionDepthSource == CollisionDepthSource.Global) return;
