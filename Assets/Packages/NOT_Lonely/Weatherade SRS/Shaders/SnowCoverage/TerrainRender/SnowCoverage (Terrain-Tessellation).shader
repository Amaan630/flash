Shader "Hidden/NOT_Lonely/Weatherade/Snow Coverage (Terrain-Tessellation)"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            HLSLPROGRAM
            #pragma require tessHW
            #define SRS_TERRAIN_SHADOW_CASTER_PASS
            ...
            #pragma shader_feature_local_vertex _TERRAIN_INSTANCED_PERPIXEL_NORMAL //SRS: add this pragma to make correct shadows on displaced terrain
            ...
            #pragma multi_compile_domain _ _CASTING_PUNCTUAL_LIGHT_SHADOW //SRS: add support for the point light shadows to the tessellation stage
