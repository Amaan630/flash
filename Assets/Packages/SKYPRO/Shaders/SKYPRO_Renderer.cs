...
public class SKYPRO_Renderer : ScriptableRendererFeature
{
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            RenderingUtils.ReAllocateIfNeeded(ref tempRenderTarget, renderingData.cameraData.cameraTargetDescriptor, name: "_TemporaryColourTexture");
    ...
    {
        m_ScriptablePass?.tempRenderTarget?.Release();
    }
}
